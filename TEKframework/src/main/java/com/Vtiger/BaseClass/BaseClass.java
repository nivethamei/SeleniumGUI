...
public class BaseClass {
	...
	public void createBCmethod() throws IOException {

		String BROWSER = System.getProperty("browser",putil.getDataFromPropertyFile("browser"));//putil.getDataFromPropertyFile("browser");
